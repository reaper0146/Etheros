...
contract Market is Ownable {
    ...
    function buyArticle(uint _id) public payable {
        ...
        // we check whether the value sent corresponds to the sensor tag
        //require(keccak256(abi.encodePacked((article.tag))) == keccak256(abi.encodePacked((msg.value))), "Value provided does not match price of article");
